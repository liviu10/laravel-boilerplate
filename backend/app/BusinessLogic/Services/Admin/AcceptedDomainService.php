    ...
    public function handleIndex($search)
    {
        ...
        if ($apiDisplayAllRecords instanceof \Illuminate\Pagination\LengthAwarePaginator)
        {
            ...
            else
            {
                ...
                $apiDataModel = $dataModel->generateDataModel('model', $this->modelName->getUniqueDomainTypes());
                $apiColumnModel = $dataModel->generateDataModel('column');
                $apiFilterModel = $dataModel->generateDataModel('filter', $this->modelName->getUniqueDomainTypes());
