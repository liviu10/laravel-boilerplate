...
/**
 * AppreciationInterface is a contract for what methods will be used in the AppreciationService class.
...
interface AppreciationInterface
{
     ...
     * @param App\Http\Requests\Admin\AppreciationRequest $request
     * @return \Illuminate\Http\Response
     */
