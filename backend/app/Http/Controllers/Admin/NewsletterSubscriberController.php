...
{
    protected NewsletterSubscriber $modelName;
     ...
     * @return Response|ResponseFactory
     */
    public function store(NewsletterSubscriberRequest $request): Response|ResponseFactory
    {
     ...
     * @return Response|ResponseFactory
     */
    public function update(NewsletterSubscriberRequest $request, string $id): Response|ResponseFactory
    {
