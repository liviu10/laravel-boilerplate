...
use App\Http\Requests\ContentVisibilityRequest;
...
{
    protected ContentVisibility $modelName;
    protected HandleApi $handleApi;

    public function __construct()
    {
        $this->modelName = new ContentVisibility();
     ...
     * @param ContentVisibilityRequest $request
     * @return Response|ResponseFactory
     */
    public function store(ContentVisibilityRequest $request): Response|ResponseFactory
    {
        $payload = $this->handleApi->handlePayload(
            ContentVisibilityRequest::class,
     ...
     * @return Response|ResponseFactory
     */
    public function update(ContentVisibilityRequest $request, string $id): Response|ResponseFactory
    {
