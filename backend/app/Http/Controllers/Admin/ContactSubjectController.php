...
{
    protected ContactSubject $modelName;
     ...
     * @return Response|ResponseFactory
     */
    public function store(ContactSubjectRequest $request): Response|ResponseFactory
    {
     ...
     * @return Response|ResponseFactory
     */
    public function update(ContactSubjectRequest $request, string $id): Response|ResponseFactory
    {
