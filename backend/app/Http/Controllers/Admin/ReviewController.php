...
{
    protected Review $modelName;
    protected HandleApi $handleApi;

    public function __construct()
    {
        $this->modelName = new Review();
     ...
     * @return Response|ResponseFactory
     */
    public function store(ReviewRequest $request): Response|ResponseFactory
    {
     ...
     * @return Response|ResponseFactory
     */
    public function update(ReviewRequest $request, string $id): Response|ResponseFactory
    {
