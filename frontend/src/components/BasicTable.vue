<template>
  <q-table
    :bordered="bordered"
    class="admin-section__basic-table"
    :columns="columns"
    :dense="dense"
    :grid="$q.screen.lt.sm"
    :loading="loading"
  ...
  >
    ...
    <template v-slot:top-right>
      <div class="admin-section__basic-table-top-right">
        <q-form>
          <q-input
            dense
    ...
    <template v-if="$q.screen.lt.sm" v-slot:item="props">
      <div class="admin-section__basic-table-content">
        <q-card>
          <q-card-section>
...
const props = withDefaults(defineProps<IBasicTable>(), {
  bordered: true,
  customLoader: true,
  dense: true,
  grid: true,
