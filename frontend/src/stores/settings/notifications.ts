...
import { IAllRecords, IAllRecordsUnpaginated, ISingleRecord } from 'src/interfaces/NotificationInterface'
...
export const useNotificationStore = defineStore('notificationStore', () => {
  ...
  async function handleIndex(type?: TResourceType) {
    try {
      handleApiResource.apiEndpoint(resourceName, useNotificationStore.$id).then(
        async (apiEndpoint) => {
          if (apiEndpoint) {
