...
import { IAllRecords, IAllRecordsUnpaginated, ISingleRecord } from 'src/interfaces/ResourceInterface'
...
export const useResourceStore = defineStore('resourceStore', () => {
  ...
  async function handleIndex(type?: TResourceType) {
    try {
      handleApiResource.apiEndpoint(resourceName, useResourceStore.$id).then(
        async (apiEndpoint) => {
          if (apiEndpoint) {
