...
import { IAllRecords, IAllRecordsUnpaginated, ISingleRecord } from 'src/interfaces/TemplateInterface'
...
export const useTemplateStore = defineStore('templateStore', () => {
  ...
  async function handleIndex(type?: TResourceType) {
    try {
      handleApiResource.apiEndpoint(resourceName, useTemplateStore.$id).then(
        async (apiEndpoint) => {
          if (apiEndpoint) {
