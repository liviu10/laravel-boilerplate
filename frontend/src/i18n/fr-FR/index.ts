...
export default {
  admin: {
    generic: {
      ...
      advanced_filters_tooltip: 'Cliquez ici pour filtrer les enregistrements',
      default_dialog_title: 'Boîte de dialogue générique',
      default_dialog_tooltip: 'Cliquez ici pour voir une boîte de dialogue générique',
      close_label: 'Fermer',
      ...
      restore_label: 'Restaurer les enregistrements',
