...
export default {
  admin: {
    generic: {
      ...
      advanced_filters_tooltip: 'Click here to filter the records',
      default_dialog_title: 'Generic dialog',
      default_dialog_tooltip: 'Click here to see a generic dialog',
      close_label: 'Close',
      cancel_label: 'Cancel',
      save_label: 'Save',
      edit_label: 'Quick edit',
      delete_label: 'Delete',
