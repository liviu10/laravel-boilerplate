...
export default {
  admin: {
    generic: {
      ...
      quick_edit_record_label: 'Editare rapidă a înregistrării',
      quick_edit_record_tooltip: 'Faceți clic aici pentru editare rapidă a înregistrării',
      delete_record_label: 'Șterge înregistrarea',
      delete_record_tooltip: 'Faceți clic aici pentru a șterge înregistrarea',
      advanced_filters_record_label: 'Filtre avansate',
      advanced_filters_record_tooltip: 'Faceți clic aici pentru a filtra înregistrările',
      default_label: 'Dialog generic',
      default_tooltip: 'Faceți clic aici pentru a vedea un dialog generic',
      close_label: 'Închide',
      ...
      restore_record_label: 'Restaurează înregistrările',
