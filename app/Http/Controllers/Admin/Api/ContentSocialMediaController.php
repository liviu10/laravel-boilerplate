...
use App\Http\Requests\ContentSocialMediaRequest;
...
{
    protected ContentSocialMedia $modelName;
    protected HandleApi $handleApi;

    public function __construct()
    {
        $this->modelName = new ContentSocialMedia();
     ...
     * @param ContentSocialMediaRequest $request
     * @return Response|ResponseFactory
     */
    public function store(ContentSocialMediaRequest $request): Response|ResponseFactory
    {
        $payload = $this->handleApi->handlePayload(
            ContentSocialMediaRequest::class,
     ...
     * @return Response|ResponseFactory
     */
    public function update(ContentSocialMediaRequest $request, string $id): Response|ResponseFactory
    {
