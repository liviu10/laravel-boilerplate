...
class ContentController extends Controller
{
     ...
     * @return Response|ResponseFactory
     */
    public function store(ContentRequest $request): Response|ResponseFactory
    {
     ...
     * @return Response|ResponseFactory
     */
    public function update(ContentRequest $request, string $id): Response|ResponseFactory
    {
