...
class ContentType extends Model
{
    ...
    public function createRecord(array $payload): ContentType|Exception
    {
        try {
            return $this->create([
                'value' => $payload['value'],
    ...
    public function updateRecord(array $payload, int $id): ContentType|Exception
    {
        try {
    ...
    public function deleteRecord(string $id): ContentType|Exception
    {
        try {
            $query = $this->find($id);
            $query->delete();
